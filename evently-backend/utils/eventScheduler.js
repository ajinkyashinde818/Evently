...
// Check for expired events and handle them
async function checkExpiredEvents() {
  try {
    console.log('Checking for expired events...');
    
    // Get events that have passed their deadline
    ...
    const expiredEvents = result.rows;
...
function startScheduler() {
  ...
  setInterval(checkExpiredEvents, 60 * 60 * 1000); // 1 hour in milliseconds
