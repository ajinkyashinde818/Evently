...
const { sendEventImagesEmail, buildImageAttachments } = require("../utils/emailService");
...
exports.uploadImages = async (req, res) => {
  ...
  try {
    ...
    const attachments = buildImageAttachments(req.files);
    ...
    setImmediate(async () => {
      ...
      const emailPromises = registrations.map(registration => 
        sendEventImagesEmail(event, registration, attachments)
      );
